    ...
    <footer className="mt-auto border-t border-[rgba(230,200,154,0.2)] bg-[linear-gradient(180deg,#25180f_0%,#1a110b_100%)] text-cream">
      <div className="mx-auto max-w-7xl px-5 py-14 md:px-8 md:py-16">
        <div className="grid gap-10 md:grid-cols-[1.15fr_0.85fr_0.95fr_0.8fr]">
          <div>
            <p className="heading-display text-3xl text-parchment">
              {site.name}
            </p>
            <p className="mt-2 text-xs uppercase tracking-[0.22em] text-latte">
              {site.headline}
            </p>
          ...
          <div>
            ...
            <address className="mt-4 not-italic space-y-2 text-sm leading-relaxed text-stone">
              ...
              <a
                href={site.phoneHref}
                className="block text-cream transition-colors hover:text-honey"
              >
                {site.phone}
              </a>
              <a
                href={`mailto:${site.email}`}
                className="block transition-colors hover:text-honey"
              >
                {site.email}
              </a>
            </address>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-stone transition-colors hover:text-honey"
                  >
                    {link.label}
                  </Link>
                </li>
